...
namespace WojciechMikołajewicz.SortedList
{
    ...
    public readonly struct SortedReadOnlyListRange<T, K1, K2, K3, K4, K5, K6> : IReadOnlyList<T>
    {
        #region Common
        /// <summary>
        ...
        public static implicit operator SortedReadOnlyListRange<T, K1, K2, K3, K4, K5, K6>(SortedReadOnlyList<T, K1, K2, K3, K4, K5, K6> orderedReadOnlyList) => new SortedReadOnlyListRange<T, K1, K2, K3, K4, K5, K6>(orderedReadOnlyList, new Range(0, orderedReadOnlyList.Count));

        /// <summary>
        /// Keys data
        /// </summary>
        private KeysData<T, K1, K2, K3, K4, K5, K6> KeysData { get; }
        ...
        public SortedReadOnlyListRange(SortedReadOnlyList<T, K1, K2, K3, K4, K5, K6> orderedList, Range range)
        {
        ...
        private SortedReadOnlyListRange(KeysData<T, K1, K2, K3, K4, K5, K6> keysData, ReadOnlyMemory<T> memory)
        {
        ...
        public SortedReadOnlyListRange<T, K1, K2, K3, K4, K5, K6> BinaryFindEqual(K1 key1)
        {
            ...
            return new SortedReadOnlyListRange<T, K1, K2, K3, K4, K5, K6>(orderedList, Memory.Slice(range.Offset, range.Length));
        }
