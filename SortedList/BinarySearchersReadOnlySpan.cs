...
namespace WojciechMikołajewicz.SortedList
{
	public static partial class BinarySearchers
	{
		...
		public static ReadOnlySpan<T> BinaryFindEqual<T, TState>(this in ReadOnlySpan<T> span, in TState state, Func<T, TState, int> comparison)
		{
		...
		public static ReadOnlySpan<T> BinaryFindLessOrEqual<T, TState>(this in ReadOnlySpan<T> span, in TState state, Func<T, TState, int> comparison)
		{
		...
		public static ReadOnlySpan<T> BinaryFindLess<T, TState>(this in ReadOnlySpan<T> span, in TState state, Func<T, TState, int> comparison)
		{
			int left = 0, right = span.Length-1, current, cmp;
		...
		public static ReadOnlySpan<T> BinaryFindGreaterOrEqual<T, TState>(this in ReadOnlySpan<T> span, in TState state, Func<T, TState, int> comparison)
		{
			int left = 0, right = span.Length-1, current, cmp;
		...
		public static ReadOnlySpan<T> BinaryFindGreater<T, TState>(this in ReadOnlySpan<T> span, in TState state, Func<T, TState, int> comparison)
		{
			int left = 0, right = span.Length-1, current, cmp;
