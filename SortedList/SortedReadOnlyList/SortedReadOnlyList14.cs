...
namespace WojciechMikołajewicz.SortedList
{
	...
	public class SortedReadOnlyList<T, K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, K12, K13, K14> : KeysData<T, K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, K12, K13, K14>, IReadOnlyList<T>
	{
		/// <summary>
		...
		public SortedReadOnlyList(IEnumerable<T> collection,
			...
			: base(keyData1, keyData2, keyData3, keyData4, keyData5, keyData6, keyData7, keyData8, keyData9, keyData10, keyData11, keyData12, keyData13, keyData14)
		{
