...
namespace WojciechMikołajewicz.SortedList
{
	...
	public class SortedReadOnlyList<T, K1, K2, K3> : SortedReadOnlyListBase<T, KeysData<T, K1, K2, K3>>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public SortedReadOnlyList(IEnumerable<T> collection,
			...
			: this(collection, new KeysData<T, K1, K2, K3>(
				keyData1,
				keyData2,
				keyData3
				))
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindEqual(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindEqual(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindEqual(key1, key2, key3);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindLessOrEqual(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindLessOrEqual(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindLessOrEqual(key1, key2, key3);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindLess(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindLess(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindLess(key1, key2, key3);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindGreaterOrEqual(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindGreaterOrEqual(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindGreaterOrEqual(key1, key2, key3);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindGreater(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindGreater(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3>)this).BinaryFindGreater(key1, key2, key3);
		}
		#endregion
