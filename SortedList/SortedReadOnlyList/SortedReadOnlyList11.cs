...
namespace WojciechMikołajewicz.SortedList
{
	...
	public class SortedReadOnlyList<T, K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11> : SortedReadOnlyListBase<T, KeysData<T, K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11>>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public SortedReadOnlyList(IEnumerable<T> collection,
			...
			: this(collection, new KeysData<T, K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11>(
				keyData1,
				keyData2,
				keyData3,
				keyData4,
