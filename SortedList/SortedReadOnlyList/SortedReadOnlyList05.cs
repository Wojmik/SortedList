...
namespace WojciechMikołajewicz.SortedList
{
	...
	public class SortedReadOnlyList<T, K1, K2, K3, K4, K5> : SortedReadOnlyListBase<T, KeysData<T, K1, K2, K3, K4, K5>>
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public SortedReadOnlyList(IEnumerable<T> collection,
			...
			: this(collection, new KeysData<T, K1, K2, K3, K4, K5>(
				keyData1,
				keyData2,
				keyData3,
				keyData4,
		...
		public SortedReadOnlyList(IEnumerable<T> collection, KeysData<T, K1, K2, K3, K4, K5> keysData)
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindEqual(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindEqual(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindEqual(key1, key2, key3);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindEqual(key1, key2, key3, key4);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindEqual(key1, key2, key3, key4, key5);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLessOrEqual(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLessOrEqual(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLessOrEqual(key1, key2, key3);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLessOrEqual(key1, key2, key3, key4);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLessOrEqual(key1, key2, key3, key4, key5);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLess(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLess(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLess(key1, key2, key3);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLess(key1, key2, key3, key4);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindLess(key1, key2, key3, key4, key5);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreaterOrEqual(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreaterOrEqual(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreaterOrEqual(key1, key2, key3);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreaterOrEqual(key1, key2, key3, key4);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreaterOrEqual(key1, key2, key3, key4, key5);
		}
		#endregion
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreater(key1);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreater(key1, key2);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreater(key1, key2, key3);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreater(key1, key2, key3, key4);
		}
		...
		{
			return ((SortedReadOnlyListRange<T, K1, K2, K3, K4, K5>)this).BinaryFindGreater(key1, key2, key3, key4, key5);
		}
		#endregion
