...
namespace WojciechMikołajewicz.SortedList
{
	public static partial class BinarySearchers
	{
		...
		public static ReadOnlyMemory<T> BinaryFindEqual<T, TState>(this in ReadOnlyMemory<T> memory, in TState state, Func<T, TState, int> comparison)
		{
		...
		public static ReadOnlyMemory<T> BinaryFindLessOrEqual<T, TState>(this in ReadOnlyMemory<T> memory, in TState state, Func<T, TState, int> comparison)
		{
		...
		public static ReadOnlyMemory<T> BinaryFindLess<T, TState>(this in ReadOnlyMemory<T> memory, in TState state, Func<T, TState, int> comparison)
		{
			int left = 0, right = memory.Length-1, current, cmp;
		...
		public static ReadOnlyMemory<T> BinaryFindGreaterOrEqual<T, TState>(this in ReadOnlyMemory<T> memory, in TState state, Func<T, TState, int> comparison)
		{
			int left = 0, right = memory.Length-1, current, cmp;
		...
		public static ReadOnlyMemory<T> BinaryFindGreater<T, TState>(this in ReadOnlyMemory<T> memory, in TState state, Func<T, TState, int> comparison)
		{
			int left = 0, right = memory.Length-1, current, cmp;
