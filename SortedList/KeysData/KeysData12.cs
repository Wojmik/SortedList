...
namespace WojciechMikołajewicz.SortedList.KeysData
{
	...
	public class KeysData<T, K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, K12> : KeysData<T, K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11>
	{
		/// <summary>
		/// Key12 data
		/// </summary>
		public KeyData<T, K12> Key12Data { get; }
											...
											if(0==(cmp=Key9Data.Comparison(Key9Data.GetMember(x), Key9Data.GetMember(y))))
												if(0==(cmp=Key10Data.Comparison(Key10Data.GetMember(x), Key10Data.GetMember(y))))
													if(0==(cmp=Key11Data.Comparison(Key11Data.GetMember(x), Key11Data.GetMember(y))))
														cmp=Key12Data.Comparison(Key12Data.GetMember(x), Key12Data.GetMember(y));
		...
		public int Compare(T item, K1 key1, K2 key2, K3 key3, K4 key4, K5 key5, K6 key6, K7 key7, K8 key8, K9 key9, K10 key10, K11 key11, K12 key12)
		{
			int cmp;
											...
											if(0==(cmp=Key9Data.Comparison(Key9Data.GetMember(item), key9)))
												if(0==(cmp=Key10Data.Comparison(Key10Data.GetMember(item), key10)))
													if(0==(cmp=Key11Data.Comparison(Key11Data.GetMember(item), key11)))
														cmp=Key12Data.Comparison(Key12Data.GetMember(item), key12);
