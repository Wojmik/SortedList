...
namespace WojciechMikołajewicz.AdvancedList
{
	...
	public class SortedReadOnlyList<T, K1, K2, K3, K4, K5, K6> : KeysData<T, K1, K2, K3, K4, K5, K6>, IReadOnlyList<T>
	{
		/// <summary>
		...
		public SortedReadOnlyList(IEnumerable<T> collection,
			...
			: base(keyData1, keyData2, keyData3, keyData4, keyData5, keyData6)
		{
