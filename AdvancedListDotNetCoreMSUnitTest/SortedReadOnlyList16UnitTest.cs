...
namespace WojciechMikołajewicz.AdvancedListDotNetCoreMSUnitTest
{
	...
	public class SortedReadOnlyList16UnitTest
	{
		...
		private static SortedReadOnlyList<SortedListItem, string, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint, ushort, Guid> SampleList { get; set; }
