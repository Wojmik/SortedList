...
{
	[TestClass]
	public class SortedReadOnlyList11UnitTest
	{
		const int KeysCount = 11;

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime> CreateSortedReadOnlyList(IEnumerable<SortedListItem> list)
		{
			return new SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime>(list, SortedReadOnlyListSampleSourceArray.AllKeysData);
		}

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime> SampleList { get; set; } = default!;
