...
namespace WojciechMikołajewicz.AdvancedListDotNetCoreMSUnitTest
{
	...
	public class SortedReadOnlyList13UnitTest
	{
		...
		private static SortedReadOnlyList<SortedListItem, string, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong> SampleList { get; set; }
