...
{
	[TestClass]
	public class SortedReadOnlyList15UnitTest
	{
		const int KeysCount = 15;

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint, ushort> CreateSortedReadOnlyList(IEnumerable<SortedListItem> list)
		{
			return new SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint, ushort>(list, SortedReadOnlyListSampleSourceArray.AllKeysData);
		}

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint, ushort> SampleList { get; set; } = default!;
		...
		[TestMethod]
		public void Equal10Find()
		{
			var comparer = new SortedListItemComparer(depth: 10);
		...
		[TestMethod]
		public void Equal11Find()
		{
			var comparer = new SortedListItemComparer(depth: 11);
		...
		[TestMethod]
		public void Equal12Find()
		{
			var comparer = new SortedListItemComparer(depth: 12);
		...
		[TestMethod]
		public void Equal13Find()
		{
			var comparer = new SortedListItemComparer(depth: 13);
		...
		[TestMethod]
		public void Equal14Find()
		{
			var comparer = new SortedListItemComparer(depth: 14);
		...
		[TestMethod]
		public void Equal15Find()
		{
			var comparer = new SortedListItemComparer(depth: 15);
		...
		[TestMethod]
		public void GreaterOrEqual10Find()
		{
			var comparer = new SortedListItemComparer(depth: 10);
		...
		[TestMethod]
		public void GreaterOrEqual11Find()
		{
			var comparer = new SortedListItemComparer(depth: 11);
		...
		[TestMethod]
		public void GreaterOrEqual12Find()
		{
			var comparer = new SortedListItemComparer(depth: 12);
		...
		[TestMethod]
		public void GreaterOrEqual13Find()
		{
			var comparer = new SortedListItemComparer(depth: 13);
		...
		[TestMethod]
		public void GreaterOrEqual14Find()
		{
			var comparer = new SortedListItemComparer(depth: 14);
		...
		[TestMethod]
		public void GreaterOrEqual15Find()
		{
			var comparer = new SortedListItemComparer(depth: 15);
