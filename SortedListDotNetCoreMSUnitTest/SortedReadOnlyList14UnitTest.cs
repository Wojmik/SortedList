...
{
	[TestClass]
	public class SortedReadOnlyList14UnitTest
	{
		const int KeysCount = 14;

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint> CreateSortedReadOnlyList(IEnumerable<SortedListItem> list)
		{
			return new SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint>(list, SortedReadOnlyListSampleSourceArray.AllKeysData);
		}

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint> SampleList { get; set; } = default!;
