...
namespace WojciechMikołajewicz.AdvancedListDotNetCoreMSUnitTest
{
	...
	public class SortedReadOnlyList14UnitTest
	{
		...
		private static SortedReadOnlyList<SortedListItem, string, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan, ulong, uint> SampleList { get; set; }
