...
{
	[TestClass]
	public class SortedReadOnlyList12UnitTest
	{
		const int KeysCount = 12;

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan> CreateSortedReadOnlyList(IEnumerable<SortedListItem> list)
		{
			return new SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan>(list, SortedReadOnlyListSampleSourceArray.AllKeysData);
		}

		private static SortedReadOnlyList<SortedListItem, string?, int, double, decimal, short, float, long, byte, char, sbyte, DateTime, TimeSpan> SampleList { get; set; } = default!;
